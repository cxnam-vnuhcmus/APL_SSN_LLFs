...
from .utils import FACEMESH_ROI_IDX, extract_llf_features, convert_emo_cremad_to_one_hot
...
class Dataset(td.Dataset):
    ...
    def __getitem__(self, idx):        
        while True:
            ...
            emo_label = audio_name.split("/")[-1].split("_")[2]
            emo_level = audio_name.split("/")[-1].split(".")[0].split("_")[3]
            emo_tensor = convert_emo_cremad_to_one_hot(emo_label, emo_level)
